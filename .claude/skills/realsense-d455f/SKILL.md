...
> 이 프로젝트에서 D455f는 공구 인식(YOLOv11s + 6D Pose, Track A/B) 및 VLA 입력(Raw RGB-D, Track C)으로 사용. 룰: [`.claude/rules/engineering.md`](../rules/engineering.md) E-1 (좌표/단위), [`.claude/rules/safety.md`](../rules/safety.md).
