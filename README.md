...
| Phase | 내용 | 상태 |
|-------|------|------|
| 0 | 환경 구성 + interfaces/HAL/unit_actions 동결 | 진입 준비 |
| 1 | 하드웨어 드라이버 (Doosan/RealSense/Gripper/PLC) | 대기 |
| 2 | 공유 퍼셉션 + 음성 (YOLOv8 + Whisper) | 대기 |
...
| 7 | 트랙 비교 평가 | 대기 |
| 8 | 테스트 (단위/통합/HIL) | 대기 |
| 9 | 배포 (systemd + Docker Compose + 모니터링) | 대기 |
