...
### ✅ 4종 서랍 시퀀스 실물 검증 완료 (`3ad8b48`)

| 시퀀스 | 팔 동작 | 그리퍼 동작 |
|--------|---------|------------|
| `open_0` (1층 열기) | ✅ 정상 | ✅ 정상 (서비스 통신) |
| `close_0` (1층 닫기) | ✅ 정상 | 미검증 |
| `open_1` (2층 열기) | ✅ 정상 | 미검증 |
| `close_1` (2층 닫기) | ✅ 정상 | 미검증 |

- `open_0` 기준: GRIP step 3회 모두 서비스 응답 확인 (pos=450 open → pos=600 grip → pos=450 open)
- close_0/open_1/close_1 그리퍼 동작은 추가 검증 필요
