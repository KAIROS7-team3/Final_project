...
현재 프로젝트에 있는 스킬 (20여 종):

| 스킬 | 내용 |
|------|------|
| `doosan-e0509.md` | Doosan 로봇팔 제어 |
| `realsense-d455f.md` | RealSense 카메라 |
| `modbus-plc.md` | PLC 통신 |
| `robotics-testing.md` | 로보틱스 테스트 방법 |
| `git-conventions.md` | 이 프로젝트 git 사용 방법 |
| ... | 등 |
